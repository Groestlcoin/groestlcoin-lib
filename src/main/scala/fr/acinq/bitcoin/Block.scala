...
case class BlockHeader(version: Long, hashPreviousBlock: ByteVector32, hashMerkleRoot: ByteVector32, time: Long, bits: Long, nonce: Long) extends BtcSerializable[BlockHeader] {
  lazy val hash: ByteVector32 = Crypto.groestl32(BlockHeader.write(this))
...
object Block extends BtcSerializer[Block] {
  ...
  val LivenetGenesisBlock = {
    ...
    Block(
      BlockHeader(version = 112, hashPreviousBlock = ByteVector32.Zeroes, hashMerkleRoot = ByteVector32(hex"bb2866aaca46c4428ad08b57bc9d1493abaf64724b6c3052a7c8f958df68e93c"), time = 1395342829, bits = 0x1e0fffff, nonce = 220035),
      List(
